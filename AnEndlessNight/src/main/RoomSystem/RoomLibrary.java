...
public class RoomLibrary 
{
	public static ArrayList<Room> roomGen()
	{
		...
		Room rm_00 = new Room("Large Hallway with wooden floors and pillars", rm_00_doors, 100, true, "Main Hallway", null, monsterFactory.setRoomMonster(0), null);
		roomObj.add(rm_00);
		rooms.clear();
